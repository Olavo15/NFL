...
const URL = "https://www.nfl.com/stats/team-stats/defense/rushing/2024/reg/all";
...
function saveToJSON(teams) {
    ...
    fs.writeFileSync('Docs/nflDefenseRushingStats.json', JSON.stringify(jsonData, null, 2), { encoding: 'utf-8' });
